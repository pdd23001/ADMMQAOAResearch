...
quad_terms = {}
penalty = 2  # Adjust penalty coefficient if needed
...
# ADMM Optimizer Parameters
admm_params = ADMMParameters(rho_initial=1, beta=10, factor_c=1, maxiter=50, three_block=False, tol=1e-4)
