...
class MinimumEigenOptimizer(OptimizationAlgorithm):
    ...
    def solve(self, problem: QuadraticProgram) -> MinimumEigenOptimizationResult:
        ...
        print("Called Solve Internal in MEO")
    ...
    def _solve_internal(
        ...
        if operator.num_qubits > 0:
            ...
            print("Computing Minimum Eigen Value")
            eigen_result = self._min_eigen_solver.compute_minimum_eigenvalue(operator) #halts at this statement
            print("Computed Minimum Eigen Value")
            # analyze results
            raw_samples = None
